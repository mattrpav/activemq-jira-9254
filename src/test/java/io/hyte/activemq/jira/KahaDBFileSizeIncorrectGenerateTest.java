...
public class KahaDBFileSizeIncorrectGenerateTest {

    // config
    protected static final int MIN_MESSAGE_LEN = 2_000;
    protected static final int MAX_MESSAGE_LEN = 5_000;
    ...
    public static void beforeClass() throws Exception {
        brokerService = BrokerFactory.createBroker(new URI("xbean:src/test/resources/conf/activemq-jira-9254.xml"));
